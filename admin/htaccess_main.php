...
require ("./templates/1/css.inc");
require ("../templates/1/rus/config.inc");
require ("../templates/1/rus/vars.txt");
$hta=$lang[42]."!";

$hta="<center>AuthUserFile ". $HTTP_SERVER_VARS['DOCUMENT_ROOT'].str_replace("http://".$_SERVER['SERVER_NAME'],"",$htpath)."<br><div align=\"center\">";
if ( isset($htuser) && isset($htpass1) &&(@$htuser!="")&&(@$htpass1!=""))
{
if( $htpass1 == $htpass2 )
  {
$htaccess = "AuthType Basic\nAuthName \"$htuserss\"\nAuthUserFile ". $HTTP_SERVER_VARS['DOCUMENT_ROOT'].str_replace("http://".$_SERVER['SERVER_NAME'],"",$htpath)."/.htpasswd\nrequire valid-user";
...
$hta.="<form method=\"POST\" action=\"htaccess_main.php\">
     <input type=\"hidden\" name=\"action\" value=\"htaccess\">
  <table border=\"0\">
      <tr>
      <td width=\"50%\">Message (0-9a-z): </td>
      <td width=\"50%\"><input type=\"text\" name=\"htuserss\" size=\"20\" value=\"".@$htuserss."\"></td>
    </tr>
    <tr>
