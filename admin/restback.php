...
<head>
<meta http-equiv=\"Content-Type\" content=\"text/html; charset=$codepage\"><title>Restore</title>
...
<b>DB:</b> $base_file<br>";
if ((!@$rest) || (@$rest=="")): $rest=""; echo "<center><small><b>DB Name Error!</b><br>"; exit; endif;

echo "<font face='Verdana, Arial, Helvetica, sans-serif' size='2' color='#000000'>$rest - <b>".$lang[209]."</b><br><br></font>";

if (!copy  ("./backup/" . $rest, ".$base_file")) {
...
?>
<br><hr><center><b>Powered by:</b> <a href=http://www.eurowebcart.com>EuroWebcart CMS</a> (c) Eurowebcart</small>
<!--end-->
</body>
</html>
