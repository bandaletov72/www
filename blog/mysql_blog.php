...
$flood="<div class=round2 align=center><br><font color=#b94a48 size=3><b>".$lang[177]."</b></font><br><br></div>";
}
if ($flood=="") {
...
<br><div class=round2 align=center>
...
if (($enable_blog_comments==1)&&($tmp[9]=="YES")) { $blog_list.="<div class=comm style=\"float:left;width:40px; overflow:hidden;\" align=center><a href=index.php?action=blog&message=$tmp[0]/$tmp[1]/$tmp[2]/$tmp[3]#view_comments><font size=4 color=$nc3>$com[0]</font></a></div><div style=\"float:left;margin-right: 10px;\"><form method=GET action=index.php#hidecomm><input type=hidden name=action value=\"blog\"><input type=hidden name=message value=\"$tmp[0]/$tmp[1]/$tmp[2]/$tmp[3]\"><input type=hidden name=hidecomm value=\"no\"><input type=submit value=\"$lang[912]\" style=\"height:30px\"></form></div>"; }
...
<br>
<div>$con</div></div>";
if (($enable_blog_comments==1)&&($tmp[9]=="YES")) { $blog_list.="<div class=comm style=\"float:left;width:40px;\" align=center><a href=\"#view_comments\"><font size=4 color=$nc3>$com[0]</font></a></div>";
} else {  $blog_list.=""; }
...
<br><div id=\"d_$key\"><a href=\"#reply\" onclick=\"javascript:document.getElementById('$key').style.display='';document.getElementById('$key').style.visibility='visible';document.getElementById('d_$key').style.display='none';document.getElementById('d_$key').style.visibility='hidden';\">$lang[806]</a>$blog_delc<div style=\"float:right; width:180px;\" align=center><font class=small><a href=\"#comment_$message/$key\">URL</a></font></div></div>
