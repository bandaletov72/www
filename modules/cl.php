...
if ((!@$wren) || (@$wren=="")): $wren=""; endif;
if ((!@$wrdis) || (@$wrdis=="")): $wrdis=""; endif;
...
if (!@unlink  ("./classifieds/base/".$bdi . $del)) {
$ggal.=  "<b>".$lang[252]."</b> $del!<br><br>\n";
} else {
@unlink  ("./classifieds/base/".$bdi . $del.".idx");
$ggal.=  $lang[209]."<br><br>\n"; }
}
if ($wren!="") {
$fp=fopen ("./classifieds/base/".$bdi . "write.txt", "w");
if (!@$fp) {
$ggal.=  "Cannot create classifieds/base/".$bdi . "write.txt!<br><br>\n";
} else {
$ggal.=  "OK<br><br>\n";
}
fclose ($fp);
...
if ($wrdis!="") {
if (unlink ("./classifieds/base/".$bdi . "write.txt")) {
$ggal.=  "OK<br><br>\n";
} else {
$ggal.=  "Cannot unlink classifieds/base/".$bdi . "write.txt!<br><br>\n";
}
}
if ($ifile!="") {

$ggal.= "<b>$lang[182]</b> OK<br><br>";
$foi="./classifieds/base/".$bdi . $ifile.".idx";
$fop=fopen($foi,"w");
...
$ggal.= "<b>".$lang[744]."</b> ./classifieds/base/$i/$deldir <br><br>";

if (deleteAll("./classifieds/base/$i/$deldir")==false){

$ggal.=$lang[747]." <b>\"./classifieds/base/$i/$deldir\"</b><br><br>\n";
...
$ggal.= "<b>".$lang[749]."</b> ./classifieds/base/$i/$mkdir <br><br>";

if (mkdir("./classifieds/base/$i/$mkdir",0755)==false){
if(is_dir("./classifieds/base/$i/$deldir")) {
$ggal.="<b>".$lang[750]."</b><br><br>\n";
} else {
$ggal.=$lang[748]." <b>\"./classifieds/base/$i/$mkdir\"</b><br><br>\n";
}
} else {$ggal.=$lang[209]."<br><br>\n";}
}
...
if (!@rename("./classifieds/base/".$bdi . $ren, "./classifieds/base/".$bdi . $newname)) {
if(@is_dir("./classifieds/base/".$bdi . $newname)) {
$ggal.="<b>".$lang[751]."</b><br><br>\n";
} else {
$ggal.=  "<b>".$lang[42]."!</b><br><br>\n";
}
} else {
@rename("./classifieds/base/".$bdi . $ren.".idx", "./classifieds/base/".$bdi . $newname.".idx");
$ggal.=  $lang[209]."<br><br>\n"; }
}
if (($ren!="")&&($newname!="")&&($ext!="")) {
...
if (!@rename("./classifieds/base/".$bdi . $ren, "./classifieds/base/".$bdi . $newname.$ext)) {
if(@file_exists("./classifieds/base/".$bdi . $newname.$ext)) {
$ggal.="<b>".$lang[751]."</b><br><br>\n";
} else {
$ggal.=  "<b>".$lang[42]."!</b><br><br>\n";
}
} else {
@rename("./classifieds/base/".$bdi . $ren.".idx", "./classifieds/base/".$bdi . $newname.$ext.".idx");
$ggal.=  $lang[209]."<br><br>\n"; }
}
$del="";
        $path = "./classifieds/base/".$bdi;
...
var aos=0;
  ...
  'onAllComplete'  : function(event,data) {
      ...
      window.location='$htpath/index.php?action=cladm&isort=$isort&i=".str_replace("//","/",str_replace("//","/", "$i"))."';
...
<input id=\"custom_file_upload\" type=\"file\" name=\"Filedata\" /></div>
      ";
      $ipl="";
$ggal.="<form enctype=\"multipart/form-data\" action='$htpath/index.php' method=POST>
        <input type='hidden' name=\"i\" value=\"".str_replace("//","/",str_replace("//","/", "$i"))."\">
        <input type='hidden' name=\"submitted\" value=\"true\">
        <input type='hidden' name=\"isort\" value=\"$isort\">
        <input type='hidden' name=\"action\" value=\"cladm\">
...
";
        ...
        <input type='hidden' name=\"start\" value=\"$start\">
        <input type='hidden' name=\"isort\" value=\"$isort\">
".$lang[749].": <b>/classifieds/base$i/</b><input type='text' name=\"mkdir\" value=\"\">
<input type='submit' value='OK'>
...
if ($bdi!="/") {
$gal.="<a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode($backurl)."\"><img src='$htpath/images/ofb.png' border=0 align=middle hspace=10></a><a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode($backurl)."\"><small><i>".$lang['back_to_higher_level']."</i></small></a><br><br><br>";
}
$gal.="";
$notf=0;
if (!is_dir("./classifieds/base/".$bdi."")) { $notf=1; } else {
$handle=opendir("./classifieds/base/".$bdi.""); $dirf=0;
...
$files_found2 = 0;
$files_found3 = 0;
if ((is_dir("./classifieds/base/".$bdi."".$fileopen)==TRUE)&&($fileopen!=".")&&($fileopen!="..")) {
if (substr($fileopen,0,1)!="#") {$dirf+=1;}
if ((substr($fileopen,-4)==".idx")||(substr($fileopen,0,3)=="tn_")) {continue;} else {
$handle2=opendir("./classifieds/base/".$bdi."$fileopen/");
while (($fileopend = readdir($handle2))!==FALSE) {
if ((is_dir("./classifieds/base/".$bdi."$fileopen/$fileopend")==TRUE)&&($fileopend!=".")&&($fileopend!="..")) {$files_found3 += 1;}
if ((is_dir("./classifieds/base/".$bdi."$fileopen/$fileopend")==FALSE)&&($fileopend!=".")&&($fileopend!="..")) {
if ((substr($fileopend,-4)==".idx")||(substr($fileopend,0,3)=="tn_")) {continue;} else {
$pos2=Array();
$pos2 = explode(".", substr($fileopend,-5));
	$typ2 = @$pos2[1];
    $typ2= ".".strtolower($typ2);
if (($typ2==".jpg")||($typ2==".jpeg")||($typ2==".gif")||($typ2==".png")||($typ2==".doc")||($typ2==".xls")||($typ2==".mp3")||($typ2==".lst")||($typ2==".txt")||($typ2==".pdf")||($typ2==".html")||($typ2==".htm")&&($typ2==".zip")||($typ2==".rar")||($typ2==".avi")||($typ2==".wmv")||($typ2==".mov")||($typ2==".flv")||($typ2==".exe")||($typ2==".ai")||($typ2==".cdr")){
...
closedir ($handle2);
if (@file_exists("./classifieds/base/".$bdi."$fileopen/icon.png")==TRUE) {

$off=$htpath."/icon.php?path=".str_replace("%2F","/", rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen"))))."/icon.png";
} else {

if ($files_found2==0) {
$off="$htpath/images/of_mini.png";
} else {
$off="$htpath/images/files.png";
}

}
$off="<img src=\"".$off."\" border=0>";
if (@file_exists("./classifieds/base/".$bdi."$fileopen/thumbs.db")==TRUE) { $off=implode("", file("./classifieds/base/".$bdi."$fileopen/thumbs.db"));  }
...
<input type=text name=\"newname\" size=\"$lenn\" value=\"$fileopen\"><input type=submit value=\"&gt;&gt;\" title=\"".$lang[390]."\"></form><br><small><b>CHMOD:</b> ".perms(fileperms(str_replace("//","/",str_replace("//","/", "./classifieds/base/$i/$fileopen"))))."</small><br><br><form class=form-inline action=\"$htpath/index.php\" method=GET id=\"form".$jsmd."\">
...
if ($hiddir==0) {
$fileopens[$s] = "<!-- 0 -->
<td class=cat3 align='left' valign='top' width=".floor(100/$gallery_cols)."%><a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen")))."\" title=\"".strip_tags($idxf)."\">$off</a><br><br><b><a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen")))."\">".strtoken("$fileopen",".")."</a></b> [$files_found3/".$files_found2."]<br>$ddir<br>".str_replace("\n","<br>", $idxf)."<br>
</td>";
$jjgal.="<li><a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen")))."\">$off</a><br><br><b><a href=\"$htpath/index.php?action=cladm&isort=$isort&i=".rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen")))."\">".strtoken("$fileopen",".")."</a></b> [$files_found3/".$files_found2."]</li>\n";
$files_found += 1;
$s+=1;
}
} else {
if (($typ!=".jpg")&&($typ!=".jpeg")&&($typ!=".gif")&&($typ!=".png")&&($typ!=".doc")&&($typ!=".xls")&&($typ!=".mp3")&&($typ!=".lst")&&($typ!=".txt")&&($typ!=".pdf")&&($typ!=".html")&&($typ!=".htm")&&($typ!=".zip")&&($typ==".wmv")&&($typ==".avi")&&($typ==".mov")&&($typ==".flv")&&($typ!=".rar")&&($typ!=".exe")&&($typ!=".ai")&&($typ!=".cdr")){
continue;
} else {
...
$mpdir="./classifieds/base/".$bdi;
// lets handle directory


if (substr($fileopen,0,3)!="tn_")  {
if (($typ==".xls")||($typ==".doc")||($typ==".pdf")||($typ==".mp3")||($typ==".lst")||($typ==".txt")||($typ==".htm")||($typ==".zip")||($typ==".rar")||($typ==".exe")||($typ==".avi")||($typ==".mov")||($typ==".wmv")||($typ==".flv")||($typ==".html")||($typ==".cdr")||($typ==".ai")) {
...
if ($typ==".mp3") {
$findmp3+=1;
if ($isort=="date") {$sortby=filemtime("./classifieds/base/".$bdi."$fileopen"); $idate=date("d/m/Y", filemtime("./classifieds/base/".$bdi."$fileopen")); } else { $sortby=$fileopen; $idate="";}
$mp3s.="$htpath/classifieds/base".$bdi.$fileopen.",";
$id3 = new id3("./classifieds/base/".$bdi."$fileopen");
if (($id3->lengths) !== -1) {
...
<td class=ocat1 align='left' valign='top' width=".floor(100/$gallery_cols)."%>$urlink<img src=\"$htpath/images/".str_replace(".","", substr($typ,-3)).".png\" border=0 title=\"".substr(str_replace("\"","", strip_tags($idxf)),0, 150)."\"></a><br><a href=\"javascript:play('$htpath/classifieds/base".$bdi.$fileopen."')\">Play</a></b>&nbsp;|&nbsp;<b><a href=\"javascript:stop()\">Stop</a></b><br><br>$hears<br>$idate<br><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><b>$form1".$ftyname."$form2</b></a> [$fsizem]<br>$ddel".str_replace("\n","<br>", $idxf)."
</td>";
$jjgal.="<li><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><img src=\"$htpath/images/".str_replace(".","", substr($typ,-3)).".png\" border=0></a><br><a href=\"javascript:play('$htpath/classifieds/base".$bdi.$fileopen."')\">Play</a></b>&nbsp;|&nbsp;<b><a href=\"javascript:stop()\">Stop</a></b><br><br>$hears<br>$idate<br><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><b>$ftyname</b></a> [$fsizem]</li>\n";
} else {
if ($isort=="date") {$sortby=filemtime("./classifieds/base/".$bdi."$fileopen"); $idate=date("d/m/Y", filemtime("./classifieds/base/".$bdi."$fileopen"));  } else { $sortby=$fileopen; $idate="";}
$fileopens[$s] = "<!-- 0".$sortby." -->
<td class=ocat1 align='left' valign='top' width=".floor(100/$gallery_cols)."%>$urlink<img src=\"$htpath/images/".str_replace(".","", substr($typ,-3)).".png\" border=0 title=\"".substr(str_replace("\"","", strip_tags($idxf)),0, 150)."\"></a><br>$idate<br><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><b>$form1".$ftyname."$form2</b></a> [$fsizem]<br>$ddel<br>".str_replace("\n","<br>", $idxf)."<br>
</td>";
$jjgal.="<li><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><img src=\"$htpath/images/".str_replace(".","", substr($typ,-3)).".png\" border=0></a><br>$idate<br><a href=\"$htpath/classifieds/base".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/",$bdi))).rawurlencode($fileopen))."\" target=\"_blank\"><b>".$ftyname."</b></a> [$fsizem]</li>\n";
}
$files_found += 1;
$s+=1;
} else {
...
$size = intval((filesize ("./classifieds/base/".$bdi."$fileopen"))/1024);
$imagesz = getimagesize("./classifieds/base/".$bdi."$fileopen");
$fwidth  = $imagesz[0];
$fheight = $imagesz[1];
...
if (file_exists( "./classifieds/base/".$bdi."tn_$fileopen")==TRUE) {
$wh=""; $tn="tn_";
}
$form1="";
$form2="";
...
$onkl=" onclick=\"javascript:window.open('".$htpath."/icon.php?path=".str_replace("%2F", "/",rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen"))))."','fr$st','status=no,scrollbars=yes,menubar=no,resizable=yes,location=no, width=".($fwidth+20).",height=".($fheight+20)."')\"";
if ($fancybox_enable!=1) {if ($form1=="") {$ftyname="<a href=#zoom$onkl>$ftyname</a>";}}
if ($isort=="date") {$sortby=filemtime("./classifieds/base/".$bdi."$fileopen"); $idate=date("d/m/Y", filemtime("./classifieds/base/".$bdi."$fileopen"));  } else { $sortby=$fileopen; $idate="";}
if ($fancybox_enable==1) {
//fancybox
$fileopens[$s] = "<!-- ".$sortby." -->
<td class=ocat1 align='left' valign='top' width=".floor(100/$gallery_cols)."%>
<a rel=\"example_group\" href=\"".$htpath."/icon.php?path=".str_replace("%2F", "/",rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$fileopen"))))."\" title=\"".substr(str_replace("\"","", strip_tags($idxf)),0, 150)."\"><img border=0 alt=\"\" src=\"".$htpath."/icon.php?path=".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$tn$fileopen"))))."\" border=\"0\" $wh title=\"".substr(str_replace("\"","", strip_tags($idxf)),0, 150)."\"></a><br>$idate<br>&nbsp;<b>$form1".$ftyname."$form2$ddel".str_replace("\n","<br>", $idxf)."<br>".str_replace("\n","<br>", $idxf)."<br>
</td>";
} else {
$fileopens[$s] = "<!-- ".$sortby." -->
<td class=ocat1 align='left' valign='top' width=".floor(100/$gallery_cols)."%><a href='#OPEN'$onkl><img src=\"".$htpath."/icon.php?path=".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$tn$fileopen"))))."\" border=\"0\" $wh title=\"".substr(str_replace("\"","", strip_tags($idxf)),0, 150)."\"></a><br>$idate<br><a href=#zoom$onkl>$zoom</a>&nbsp;<b>$form1".$ftyname."$form2</a>$ddel<br>".str_replace("\n","<br>", $idxf)."<br>
</td>";
}
$jjgal.="<li><a href='#OPEN'$onkl><img src=\"".$htpath."/icon.php?path=".str_replace("%2F", "/", rawurlencode(str_replace("//","/",str_replace("//","/", "$i/$tn$fileopen"))))."\" border=\"0\" $wh></a><br>$idate<br><b>$ftyname</b></li>\n";
$files_found += 1;
$s+=1;
}
}
...
if (file_exists("./classifieds/base".str_replace("//","/",str_replace("//","/",$i))."/write.txt")==false) {
$writer="<br><form class=form-inline action=\"$htpath/index.php\" method=POST>
<input type=hidden name=\"i\" value=\"".str_replace("//","/",str_replace("//","/",$i))."\">
<input type=hidden name=\"wren\" value=1>
<input type=hidden name=\"action\" value=\"cladm\">
<input type='hidden' name=\"isort\" value=\"$isort\">
<input type='hidden' name=\"perpage\" value=\"$perpage\">
<input type='hidden' name=\"start\" value=\"$start\">
<font color=#b94a48 size=3><b>".$lang[962]."</b></font><br><input type=submit value=\"".$lang[960]."\"></form>";
} else {
$writer="<br><form class=form-inline action=\"$htpath/index.php\" method=POST>
<input type=hidden name=\"i\" value=\"".str_replace("//","/",str_replace("//","/",$i))."\">
<input type=hidden name=\"wrdis\" value=1>
<input type=hidden name=\"action\" value=\"cladm\">
<input type='hidden' name=\"isort\" value=\"$isort\">
<input type='hidden' name=\"perpage\" value=\"$perpage\">
<input type='hidden' name=\"start\" value=\"$start\">
<font color=#468847 size=3><b>".$lang[963]."</b></font><br><input type=submit value=\"".$lang[961]."\"></form>";
}
