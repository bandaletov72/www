...
$widget= "<div class=\"dropdown\"><a href=\"#\" class=shadow data-toggle=\"dropdown\" style=\"background-color: $nc4; position: fixed; top: ".((43+$popr)+$expos*(40+$popr))."px; right: -12px; margin-top:0px; width: ".(40+$popr). "px; height:".(37+$popr). "px; z-index:".(5000-$expos)."; padding: 0px 0px 0px 6px;\" title=\"$lang[60]\" onmouseover=\"javascript:this.style.width='".(60+$popr)."px';\" onmouseout=\"javascript:this.style.width='".(40+$popr). "px';\" id=tipadm><img src=\"$image_path/pix.gif\" align=absmiddle width=26 height=8><br><font class=small color=$nc0><span class=nowrap>ADM&nbsp;<i class=\"icon-chevron-down icon-white\"></i></span></font></a><ul id=admmenu style=\"height:490px; width:400px; padding: 10px 10px 10px 10px; overflow:auto; position: fixed; top: 80px; right: -1px; text-align:left; align:left;\" class=\"dropdown-menu pull-right\" role=\"menu\" aria-labelledby=\"dLabel\">";
...
$callbackform="<a id=\"tip5\" title=\"$lang[1153]\" href=\"#login_form\"><font color=$nc5><b>".$lang[1153]."</b><br><font class=small>".$lang[1150]."</font></font></a>";
...
$cbdiv="<a id=\"tip5\" title=\"$lang[1153]\" href=\"#login_form\"><img src=$image_path/phone2.png border=0 title=\"".$lang[1153]."\"></a>$callbackdiv";
if ($skypename!="") {
