...
$orderway="";
$ff=0;
$mysql_query="SELECT * FROM $file WHERE (`keywords` LIKE '%\%%'"."$add_query) ORDER BY RAND() LIMIT 0,$top_sales_max";
...
<tr><td valign=top align=center><font size=2>$carat <a class=\"btn btn-warning\" href=\"$htpath/index.php?query=showsales\"><i class=icon-tags></i><font color=#ffffff> $lang[422]</font></a></font><br>
...
$s=0;
if ($top_sales_spisok!="") {
top("", "<b><font size=3>".$lang[233]."</font></b>$top_sales_spisok", $style ['center_width'], $nc0, $nc0, 5,0,"[top_sales]");
}
}
if ($interface==1) {
