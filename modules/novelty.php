...
$st += 1;
$ddt += 1;
$noveltys_spisok .= "<!-- xxx ---> $val <!-- end xxx --->\n";
if ($st>$make_col) { $make_col+=$cols_of_goods; if ($cols_of_goods>1) {$ddt+=1;} $noveltys_spisok.="</tr><tr>";}
}
$noveltys_spisok = "<table border=0 cellspacing=0 cellpadding=5 width=100%>
<tr>
<!-- novelty -->
$noveltys_spisok
<!-- end novelty -->
...
$total-=1;
} else {$files_found=0; $s=0; $noveltys_spisok="";}

if ($files_found==0): $noveltys_spisok =""; $error = ""; endif;
if ($s==0): $noveltys_spisok=""; endif;
?>
