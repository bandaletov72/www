...
if (@$sps3[$c_num]=="") {
if ($mod_rw_enable==0) {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><b><a href=\"$htpath/index.php?catid=".$c_line."\">".@$expl[1]."</a></b>".@$sps4[$c_num]."</div>\n";
} else {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><b><a href=\"$htpath/".$c_line."\">".@$expl[1]."</a></b>".@$sps4[$c_num]."</div>\n";
}
} else {
if ($mod_rw_enable==0) {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><a href=\"$htpath/index.php?catid=$c_line\" title=\"".$expl[1]."\">".$sps3[$c_num]."</a><div class=\"nw lnk\"><b><a href=\"$htpath/index.php?catid=".$c_line."\">".$expl[1]."</a></b>$sps4[$c_num]</div></div>\n";
} else {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><a href=\"$htpath/$c_line\" title=\"".$expl[1]."\">".$sps3[$c_num]."</a><div class=\"nw lnk\"><b><a href=\"$htpath/".$c_line."\">".$expl[1]."</a></b>$sps4[$c_num]</div></div>\n";
}
}	} else {
...
if ($mod_rw_enable==0) {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><a href=\"$htpath/index.php?catid=$c_line\" title=\"".$expl[1]."\">".$logodirsy[$c_num]."</a><div class=\"nw lnk\"><b><a href=\"$htpath/index.php?catid=".$c_line."\">".$expl[1]."</a></b>$sps4[$c_num]</div></div>\n";
} else {
$spisoks.="<div class=\"lgdiv\" style=\"display:inline-block;\"><a href=\"$htpath/$c_line\" title=\"".$expl[1]."\">".$logodirsy[$c_num]."</a><div class=\"nw lnk\"><b><a href=\"$htpath/".$c_line."\">".$expl[1]."</a></b>$sps4[$c_num]</div></div>\n";
}
}
...
if ($spisoks!="") {
$spisoks = "<div style=\"text-align:center;\">
$spisoks<div class=clearfix></div></div>
\n";
}
...
$brandimg="<div class=round3><div class=\"pull-left mr\">".$img."</div><div class=\"pull-left\"><b><font size=3>$brandimg</font></b>$text$site</div><div class=clearfix></div></div>";
}
...
$ddescription.="<div class=customdiv><div class=pull-left><b>$cac_line: </b></div><div class=\"pull-left ml\">". @$out[$cac_num] ." ". $cartl2[$cac_num]."</div><div class=clear></div></div>\n";
}
}
}
}
...
$stoks= "<small><img src=$image_path/stockno.png><br>".$lang[175]."</small>";
}
$val=str_replace("[sklad]",$stoks,$val);
}
if ($stinfo=="int") {
if ($kolvos[$sklname]==1) {$stoks= "<img src=$image_path/stock1.png style=\"cursor:help;\" title=\"".$lang[622]."\">";}
if ($kolvos[$sklname]>$stock4) {$stoks= "<img src=$image_path/stock1.png style=\"cursor:help;\" title=\"".$lang[623]."\">";}
if ($kolvos[$sklname]>=$stock3) {$stoks= "<img src=$image_path/stock3.png style=\"cursor:help;\" title=\"".$lang[624]."\">";}
if ($kolvos[$sklname]>=$stock2) {$stoks= "<img src=$image_path/stock3.png style=\"cursor:help;\" title=\"".$lang[624]."\">";}
if ($kolvos[$sklname]>=$stock1) {$stoks= "<img src=$image_path/stock5.png style=\"cursor:help;\" title=\"".$lang[625]."\">";}
if ($kolvos[$sklname]>=$stock0) {$stoks= "<img src=$image_path/stock5.png style=\"cursor:help;\" title=\"".$lang[626]."\">";}
if ($kolvos[$sklname]<=$stock5) {$stoks= "<img src=$image_path/stockno.png style=\"cursor:help;\" title=\"".$lang[621]."\">";}
...
if (($s+1)==$numberpages) {
$pp.= "<a href = \"$htpath/index.php?catid=".$podstava["$r|$sub|"]."$queryed&start=" . ($s*$perpage) . "&perpage=$perpage&brand=".rawurlencode($brand)."\"><font size=2 color=$nc3 style=\"border-bottom: 1px dotted;\">" . ($s+1) . "</font></a>";
} else {
$pp.= "<a href = \"$htpath/index.php?catid=".$podstava["$r|$sub|"]."$queryed&start=" . ($s*$perpage) . "&perpage=$perpage&brand=".rawurlencode($brand)."\"><font size=2 color=$nc3 style=\"border-bottom: 1px dotted;\">" . ($s+1) . "</font></a> <img src=\"$image_path/a.gif\"> ";
}
}
}
$s+=1;
}
if ($td>0) { if ($td>1) { $pp="<a href = \"$htpath/index.php?catid=".$podstava["$r|$sub|"]."$queryed&start=0&perpage=$perpage&brand=".rawurlencode($brand)."\"><font size=2 color=$nc3 style=\"border-bottom: 1px dotted;\">1</font></a> <img src=\"$image_path/a.gif\"> ... <img src=\"$image_path/a.gif\"> $pp"; } else { $pp="<a href = \"$htpath/index.php?catid=".$podstava["$r|$sub|"]."$queryed&start=0&perpage=$perpage&brand=".rawurlencode($brand)."\"><font size=2 color=$nc3 style=\"border-bottom: 1px dotted;\">1</font></a> <img src=\"$image_path/a.gif\"> $pp"; } }
if ($ts>0) { if ($ts>1) {$pp.="... <img src=\"$image_path/a.gif\">";} $pp.=" <a href=\"$htpath/index.php?catid=".$podstava["$r|$sub|"]."$queryed&start=" . ($perpage*($numberpages-1)) . "&perpage=$perpage&brand=".rawurlencode($brand)."\"><font size=2 color=$nc3 style=\"border-bottom: 1px dotted;\">" . $numberpages . "</font></a>";}
...
if ($files_found==0): $spisok =""; $error = "<br><br><font color=$nc3><b>".$lang[94]."</b></font><br><br>"; endif;
