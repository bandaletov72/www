...
$map3.="<div class=\"pull-left mr mb\"><a href=index.php?unifid=$lid class=cat1><img src=$image_path/pin.png border=0> <b>$o[3]</b></a><br><small>$o[7]</small></div>";
}
}
}
}
...
background-image: url('images/light.png'); background-repeat: repeat-y; background-position: center\"><table style=\"width:$shwid\" align=center border=0><tr><td>$x0007</td></tr></table></div>";
}
...
-moz-box-shadow:0 0px 5px ".lighter($nc6,-20).";
box-shadow: 0 0px 5px ".lighter($nc6,-20).";
background-image: url('images/light.png'); background-repeat: repeat-y; background-position: center\"><table style=\"width:$shwid\" align=center border=0><tr><td>$catid_content</td></tr></table></div>";
}
